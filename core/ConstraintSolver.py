...
# class ConflictDirectedBackjumpingSolver(ConstraintSolver):
#     def __init__(self, csp: CSP) -> None:
#         super().__init__(csp)
#         self.conflict_sets = {name: [] for name in self.csp.variables}
...
#                 if forward_checking(self.csp, name, assignment):
#                     removals = self._backjump(assignment)
#                     if removals:
#                         return assignment
...
#         return self._backjump(assignment)
